...
(function (global) {
  ...
  const DICT = {
    ko: {
      brand: 'prj-livesub', onAir: 'ON AIR', offAir: 'OFF AIR', noLink: '연결 없음',
      subLang: '자막 언어', delay: '딜레이', sync: 'PING', buffer: '전송대기',
      bufOk: '정상', bufWait: '대기', bufFail: '실패', bufOff: '연결 끊김',
      connected: '연결된 사람', me: '나', roleTypist: '속기', roleBroadcast: '송출',
      noVideo: '영상 입력 없음',
      noVideoSub: '관리자 콘솔의 <b>영상 소스</b>에서 주소를 넣으면 여기에 바로 뜹니다',
      vConnecting: 'CONNECTING', vLive: 'LIVE', vRetrying: 'RECONNECTING', vSignalLost: 'NO SIGNAL',
      vSoundOn: '소리 켜기', vMute: '음소거',
      vNoPlayer: (n) => `${n} 플레이어 파일이 없습니다. README의 설치 항목을 보세요.`,
      vSldpTodo: 'SLDP 플레이어가 아직 연동되지 않았습니다.',
      noSignal: 'NO SIGNAL',
      refOnly: '참고용',
      refOnlyTip: '이 그림은 참고용입니다. 스튜디오가 받는 영상과 여기 영상은 경로가 달라 몇 초까지 어긋날 수 있습니다. 자막이 실제로 언제 겹쳐 나가는지는 이 화면으로 판단할 수 없습니다.',
      vResyncTip: '눌러서 영상을 현재 시점으로 다시 맞춥니다',
      swapTip: '영상과 최근 전송의 자리를 바꿉니다',
      themeLight: '🤓', themeDark: '😎',
      themeLightTip: '라이트 모드로 — 밝은 사무실에서 볼 때',
      themeDarkTip: '다크 모드로 — 조명을 낮춘 중계실에서 볼 때',
      tipDelay: '자막을 보낸 뒤 실제로 송출될 때까지 기다리는 시간. 아래 슬라이더로 바꾸며 방 전체에 함께 적용됩니다.',
      tipPing: '이 화면과 서버 사이 왕복 시간. 300ms를 넘으면 주황색이 됩니다. 영상과는 무관합니다.',
      tipBuffer: '내가 보낸 자막의 대기열. 딜레이를 기다리는 중이면 대기, 서버에 못 보냈으면 실패로 표시됩니다.',
      tipLang: '이 화면이 담당하는 자막 언어. 다른 언어로 보내려면 그 언어의 주소를 열어야 합니다.',
      tipOnAir: '이 언어의 송출 화면이 접속해 있고 자막이 떠 있는지. 접속이 없으면 OFF AIR입니다.',
      tipPeers: '같은 언어 방에 접속한 사람. 옆 숫자는 그 사람의 왕복 시간입니다.',
      ovNoOutput: '송출 화면이 없어 자막 미리보기가 비어 있습니다. 송출용 화면을 한 대 열어두세요.',
...
tCleared: '송출 자막을 모두 숨겼습니다',
    ...
    en: {
      brand: 'prj-livesub', onAir: 'ON AIR', offAir: 'OFF AIR', noLink: 'NO LINK',
      subLang: 'Subtitle', delay: 'Delay', sync: 'PING', buffer: 'Queue',
      bufOk: 'OK', bufWait: 'Queued', bufFail: 'Failed', bufOff: 'Offline',
      connected: 'Connected', me: 'me', roleTypist: 'Typist', roleBroadcast: 'Output',
      noVideo: 'No video input',
      noVideoSub: 'Set the address under <b>Video source</b> in the console and it appears here',
      vConnecting: 'CONNECTING', vLive: 'LIVE', vRetrying: 'RECONNECTING', vSignalLost: 'NO SIGNAL',
      vSoundOn: 'Turn sound on', vMute: 'Mute',
      vNoPlayer: (n) => `The ${n} player file is missing - see the install notes in the README.`,
      vSldpTodo: 'The SLDP player is not wired up yet.',
      noSignal: 'NO SIGNAL',
      refOnly: 'REFERENCE',
      refOnlyTip: 'This picture is for reference. It reaches you by a different path than the studio feed and can be seconds apart, so it cannot tell you when a subtitle actually lands on air.',
      vResyncTip: 'Click to resync the picture to now',
      swapTip: 'Swap the video and the recent list',
      themeLight: '🤓', themeDark: '😎',
      themeLightTip: 'Switch to light - for a lit room',
      themeDarkTip: 'Switch to dark - for a dimmed control room',
      tipDelay: 'How long a line waits after you send it before it reaches air. The slider below changes it for the whole room.',
      tipPing: 'Round trip between this screen and the server. Turns amber past 300ms. Nothing to do with the video.',
      tipBuffer: 'Your own outgoing queue: Queued while a line waits out the delay, Failed if it never reached the server.',
      tipLang: 'The subtitle language this screen feeds. Another language means opening that language address.',
      tipOnAir: 'Whether an output screen for this language is connected and showing something.',
      tipPeers: 'Everyone in this language room. The number beside a name is their round-trip time.',
      ovNoOutput: 'No output screen is connected, so the subtitle preview stays empty. Open one output screen.',
