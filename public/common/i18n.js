...
(function (global) {
  ...
  const DICT = {
    ko: {
      ...
      noVideo: '영상 입력 없음',
      noVideoSub: '<code>config.json</code>의 <code>video.url</code> 또는 <code>?video=&lt;url&gt;</code>로 연결합니다',
...
tCleared: '송출 자막을 모두 숨겼습니다',
    ...
    en: {
      ...
      noVideoSub: 'Set <code>video.url</code> in <code>config.json</code>, or pass <code>?video=&lt;url&gt;</code>',
      vConnecting: 'CONNECTING', vLive: 'LIVE', vRetrying: 'RECONNECTING', vSignalLost: 'NO SIGNAL',
